...
public void opennotificationmethod() throws MalformedURLException
{
	...
	driver.findElementById("com.bhanu.notificationreminders:id/txtNewNoteTitle").sendKeys("kavya");
	driver.findElementById("com.bhanu.notificationreminders:id/txtNewNoteText").sendKeys("poo");
