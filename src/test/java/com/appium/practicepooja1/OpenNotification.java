...
public class OpenNotification {
	...
	public void opennotificationmethod() throws MalformedURLException
	{
		...
		driver.findElementById("com.bhanu.notificationreminders:id/txtNewNoteTitle").sendKeys("NoteTitle");
		driver.findElementById("com.bhanu.notificationreminders:id/txtNewNoteText").sendKeys("NoteContent");
